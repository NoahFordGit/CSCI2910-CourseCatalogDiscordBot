    ...
    async execute(interaction, courseID, fromButton = false) {
        try {
            ...
            if (!Array.isArray(coreqs)) {
                throw new Error('Invalid corequisites data received from API.');
            }
            ...
            // Handle empty corequisites
            if (coreqs.length === 0) {
                const noneEmbed = new EmbedBuilder()
                    .setColor(0xFFC72C)
                    .setTitle(`${courseId} Corequisites`)
                    .setDescription('This course has no corequisites!')
            ...
            console.log('Error fetching course requisites:', error);

            const errorEmbed = new EmbedBuilder()
                .setColor(0xFF2C2C)
                .setTitle('Error Fetching Course Corequisites')
